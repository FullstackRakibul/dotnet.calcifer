...
{
    /// <inheritdoc />
    public partial class InitialLaunch : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommonStatus", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublicData", x => x.Guid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LicenseGuid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Licenses_CommonStatus_StatusId",
                        column: x => x.StatusId,
                        principalTable: "CommonStatus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_CommonStatus_StatusId",
                        column: x => x.StatusId,
                        principalTable: "CommonStatus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_OrganizationUnits_BaseUnitId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivatedByUserId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PermissionCache", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PermissionCache_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PermissionCache_OrganizationUnits_UnitId",
                        column: x => x.UnitId,
                        principalTable: "OrganizationUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDirectPermissions", x => new { x.UserId, x.PermissionId });
                    table.ForeignKey(
                        name: "FK_UserDirectPermissions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserDirectPermissions_Permissions_PermissionId",
                        column: x => x.PermissionId,
                        principalTable: "Permissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserUnitRoles", x => new { x.UserId, x.RoleId, x.UnitId });
                    table.ForeignKey(
                        name: "FK_UserUnitRoles_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserUnitRoles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserUnitRoles_OrganizationUnits_UnitId",
                        column: x => x.UnitId,
                        principalTable: "OrganizationUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_BaseUnitId",
                table: "AspNetUsers",
                column: "BaseUnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommonStatus_ModuleActive",
                table: "CommonStatus",
                columns: new[] { "Module", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_LicenseActivation_LicenseMachine",
                table: "LicenseActivations",
                columns: new[] { "LicenseId", "MachineId" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermissionCache_UnitId",
                table: "PermissionCache",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_PermissionCache_UserUnit",
                table: "PermissionCache",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permission_ModuleResourceAction",
                table: "Permissions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDirectPermissions_PermissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserUnitRoles_RoleId",
                table: "UserUnitRoles",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_UserUnitRoles_UnitId",
                table: "UserUnitRoles",
                column: "UnitId");
        }
